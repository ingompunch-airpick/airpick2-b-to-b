      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-neutral-950/80 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-4 border-b border-neutral-800/50 flex items-center justify-between bg-[#121212]">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[9px] text-zinc-400 font-bold tracking-tight uppercase">TIME SELECTION CENTER</p>
              </div>
            </div>
            <button 
              type="button"
          ...
          <div className="p-4.5 space-y-4 max-h-[75vh] overflow-y-auto">
            ...
            {/* Hours Selector Grid */}
            <div>
              <span className="text-[10px] text-[#FFFFFF] font-extrabold block mb-2">시간 선택 (Hour)</span>
            ...
            <div>
              <span className="text-[10px] text-[#FFFFFF] font-extrabold block mb-2">분 선택 (Minute - 5분 단위)</span>
              <div className="grid grid-cols-4 gap-1.5">
                {minutes.map((min) => {
            ...
            <div className="p-3 bg-[#141416] border border-neutral-850 rounded-xl flex items-center justify-between">
              <span className="text-[10px] text-zinc-300 font-black">선택한 시간</span>
