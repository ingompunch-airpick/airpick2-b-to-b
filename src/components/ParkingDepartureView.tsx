    ...
    <div className="min-h-screen bg-neutral-950 text-white p-5 pb-24 select-none">
      ...
      <div className="flex items-center gap-3.5 mb-6">
        ...
        <div>
          ...
          <p className="text-[10px] text-zinc-500 font-bold uppercase font-mono">Real-time Parking Space Allocation</p>
        </div>
      </div>
      ...
      <div className="bg-neutral-900/40 p-1.5 border border-neutral-850 rounded-2xl mb-5">
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <span className={`text-[10px] font-mono font-bold ${activeTab === 'indoor' ? 'text-neutral-900/70' : 'text-zinc-500'}`}>
          ...
          >
            ...
            <span className={`text-[10px] font-mono font-bold ${activeTab === 'outdoor' ? 'text-neutral-900/70' : 'text-zinc-500'}`}>
      ...
      <div className="bg-neutral-900/80 border border-neutral-850 rounded-2xl p-4 mb-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 font-semibold uppercase font-mono mt-0.5">
              {activeTab === 'indoor' ? 'Indoor Parking Zone' : 'Outdoor Parking Zone'}
            </p>
          </div>
        </div>
        <div className="text-right">
          <span className="text-[11px] font-bold text-[#8E8E93] block">총 주차 대수</span>
      ...
      <div className="space-y-3">
        {displayedReservations.length > 0 ? (
            ...
            >
              ...
              <div className="flex justify-between items-center flex-wrap gap-2">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-[9.5px] font-mono bg-neutral-950 text-zinc-400 px-2 py-0.5 rounded border border-neutral-850 font-bold">
                    {res.phone || '010-0000-0000'}
                  </span>
                  {isReservationUnpaid(res) && (
                    <span className="text-[9px] font-black px-2 py-0.5 rounded-md bg-rose-500/15 text-rose-400 border border-rose-500/25">
                      미납
                    </span>
                  )}
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  <button 
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 bg-neutral-950 border border-neutral-800 hover:border-amber-500 text-[10px] font-bold text-[#8E8E93] hover:text-amber-500 rounded-lg transition-all duration-100"
                  >
                    <Edit size={10} />
                    수정
                  </button>
                  <button 
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 bg-neutral-950 border border-neutral-800 hover:border-red-500 text-[10px] font-bold text-[#8E8E93] hover:text-red-500 rounded-lg transition-all duration-100"
                  >
                    <Trash2 size={10} />
                    삭제
                  </button>
                  <span className="text-[9.5px] font-bold text-zinc-400 bg-neutral-950 border border-neutral-850 px-2.5 py-1 rounded-md">
                    대행: {res.companyName}
                  </span>
                </div>
              </div>
              ...
              <div className="p-3 bg-neutral-950 border border-neutral-850 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="text-[9px] text-zinc-500 block leading-none uppercase font-bold mb-0.5">모델 분류</span>
              ...
              <div className="flex flex-col gap-1 text-[10px] text-zinc-400 font-mono pt-1.5 border-t border-neutral-850/60">
          ...
          <div className="p-12 text-center bg-neutral-900/20 border border-dashed border-neutral-850 rounded-3xl">
            ...
            <p className="text-[9.5px] text-neutral-650 mt-1 font-medium">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-neutral-950/80 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-[#121212] rounded-2xl border border-neutral-800 overflow-hidden shadow-2xl flex flex-col font-sans">
            ...
            <div className="p-4 border-b border-neutral-800/50 flex items-center justify-between bg-[#141416]/50">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-[#8E8E93] font-bold tracking-wide uppercase">EDIT VEHICLE DETAILS</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="p-4.5 space-y-3.5 max-h-[60vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-[9.5px] text-zinc-500 font-black block mb-1">고객명</label>
                  <input
                    type="text"
                    value={editUserName}
                ...
                <div>
                  <label className="text-[9.5px] text-zinc-500 font-black block mb-1">연락처</label>
                  <input
                    type="text"
                    value={editPhone}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-[9.5px] text-zinc-500 font-black block mb-1">차종</label>
                  <input
                    type="text"
                    value={editCarModel}
                ...
                <div>
                  <label className="text-[9.5px] text-zinc-500 font-black block mb-1">차량번호</label>
                  <input
                    type="text"
                    value={editCarNumber}
              ...
              {/* 주차 타입: 실내 / 실외 전환 */}
              <div>
                <label className="text-[9.5px] text-zinc-500 font-black block mb-1">주차장 구분</label>
              ...
              {/* 주차 구역 (parkingSpace) */}
              <div>
                <label className="text-[9.5px] text-zinc-500 font-black block mb-1">주차 구역 번호</label>
                <input
                  type="text"
              ...
              <div className="pt-1 border-t border-neutral-850/80 space-y-3">
                <p className="text-[10px] font-black text-amber-500">일정 (입·출차)</p>
                <p className="text-[9px] text-zinc-500 -mt-2 leading-relaxed">
                  예약보다 일찍·늦게 온 경우 입고 예정·실제 입고·출차 예정을 맞춰 주세요. 저장 시 요금이 다시 계산됩니다.
                </p>

                <div>
                  <label className="text-[9.5px] text-zinc-500 font-black block mb-1">입고 터미널</label>
                  <div className="grid grid-cols-2 gap-2 bg-[#1C1C1E]/50 border border-neutral-850 p-1 rounded-xl">
                ...
                <div className="grid grid-cols-2 gap-2 font-mono">
                  <div>
                    <label className="text-[9.5px] text-zinc-500 font-black block mb-1">입고 예정일</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="text-[9.5px] text-zinc-500 font-black block mb-1">입고 예정시간</label>
                    <input
                      type="time"
                ...
                <div className="grid grid-cols-2 gap-2 font-mono">
                  <div>
                    <label className="text-[9.5px] text-zinc-500 font-black block mb-1">실제 입고일</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="text-[9.5px] text-zinc-500 font-black block mb-1">실제 입고시간</label>
                    <input
                      type="time"
                ...
                <button
                  ...
                  className="w-full py-2 text-[10px] font-black rounded-lg border border-neutral-800 bg-neutral-950 text-zinc-300 hover:text-white hover:border-amber-500/40 transition-all"
                >
                  실제 입고 → 지금 시각으로
                </button>

                <div>
                  <label className="text-[9.5px] text-zinc-500 font-black block mb-1">출차 터미널</label>
                  <div className="grid grid-cols-2 gap-2 bg-[#1C1C1E]/50 border border-neutral-850 p-1 rounded-xl">
                    {(['T1', 'T2'] as const).map((t) => (
                      <button
                        key={t}
                ...
                <div className="grid grid-cols-2 gap-2 font-mono">
                  <div>
                    <label className="text-[9.5px] text-zinc-500 font-black block mb-1">출차 예정일</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="text-[9.5px] text-zinc-500 font-black block mb-1">출차 예정시간</label>
                    <input
                      type="time"
              ...
              {/* 수납 상태 (주차 후 계좌 입금 등) */}
              <div>
                <label className="text-[9.5px] text-zinc-500 font-black block mb-1.5">수납 상태</label>
                <div className="grid grid-cols-2 gap-2">
                  <button
                    type="button"
                    onClick={() => setEditPaymentChoice('unpaid')}
                    className={`py-2.5 text-[11px] font-black rounded-xl border transition-all ${
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-neutral-950/80 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-[#121212] rounded-2xl border border-neutral-800 overflow-hidden shadow-2xl flex flex-col font-sans">
            ...
            <div className="p-6 text-center space-y-4">
              ...
              {/* Target info box */}
              <div className="p-3.5 bg-neutral-950 border border-neutral-850 rounded-xl space-y-1 text-left font-mono text-[10.5px]">
